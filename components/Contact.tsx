        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-10">
          <Reveal>
            ...
            <p className="text-lg text-gray-200 max-w-2xl mx-auto leading-relaxed">
              We'd love to discuss your project. Reach out to Nakshatra
              Technologies today.
            </p>
          </Reveal>
        </div>
          ...
          <div className="bg-white rounded-t-xl lg:rounded-l-xl lg:rounded-tr-none shadow-xl overflow-hidden flex flex-col h-full border-r border-gray-100">
            ...
            <div className="p-8 lg:p-12 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12 flex-grow items-center">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-slate-700 font-semibold">+91 8975221255</p>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <a
                  href="mailto:nakshatratechnologies0425@gmail.com"
                  className="text-slate-700 font-semibold hover:text-blue-600 transition-colors underline decoration-blue-500/30"
                >
                  nakshatratechnologies0425@gmail.com
                </a>
              </div>
              ...
              <div className="flex flex-col items-center text-center col-span-1 md:col-span-2 border-t border-gray-100 pt-8 mt-4 md:mt-0">
                ...
                <p className="text-slate-700 max-w-xs leading-relaxed font-medium">
                  {" "}
                  Pune IT Park, Maharashtra, India.
                </p>
              </div>
                  ...
                  <div className="bg-white p-2 rounded-md shadow-sm border border-gray-300 focus-within:border-blue-500 transition-colors">
                    <div className="flex items-center px-2">
                      ...
                      <input
                        ...
                        required
                        className="w-full py-2 outline-none text-slate-900 placeholder:text-gray-500 bg-transparent"
                      />
                    </div>
                  </div>
                  <div className="bg-white p-2 rounded-md shadow-sm border border-gray-300 focus-within:border-blue-500 transition-colors">
                ...
                <div className="bg-white p-2 rounded-md shadow-sm border border-gray-300 focus-within:border-blue-500 transition-colors">
                  <div className="px-2 py-1">
                    <textarea
                      ...
                      rows={4}
                      required
                      className="w-full py-1 outline-none text-slate-900 placeholder:text-gray-500 bg-transparent resize-none"
                    ></textarea>
                  </div>
                </div>
                  ...
                  {submitStatus === "success" && (
                    <div className="p-5 bg-white border border-green-200 rounded-2xl animate-fade-in shadow-sm border-l-4 border-l-green-500">
                      ...
                      <p className="text-slate-500 text-xs mt-2 leading-relaxed font-medium">
                        We’ve successfully received your requirement. Our
                        experts will contact you shortly to discuss your
                        project.
                      </p>
                    </div>
                  )}
                  {submitStatus === "error" && (
                    <p className="text-red-600 text-sm font-bold text-center animate-fade-in">
